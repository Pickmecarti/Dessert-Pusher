 ...
 * how many seconds since it started, every second.
 *
 * -----
 *
 * Handler and Runnable are beyond the scope of this lesson. This is part of a deeper dive
 * into threading.
 */
class DessertTimer(lifecycle: Lifecycle) : LifecycleObserver {
    ...
    init {
        // Add this DessertTimer as an observer to the lifecycle
